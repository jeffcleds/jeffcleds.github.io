    ...
    <div className="mb-6 last:mb-0">
      <div className="flex justify-between items-center mb-2">
        ...
        <div className="flex flex-col items-end">
          <span className="inline-flex items-center rounded-full bg-primary/10 px-3 py-1 text-sm font-medium text-primary mb-2 whitespace-nowrap"> {/* Added whitespace-nowrap */}
            {education.date}
          </span>
          {education.logo && (
            <img
