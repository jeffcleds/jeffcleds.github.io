...
export const profileData = {
  ...
  introduction: `My name is <span class="highlight">Ernie Joseph Cledera</span>, a tech-savvy Virtual Assistant with 5+ years of experience optimizing workflows, data management, and digital tools to deliver accurate, high-quality support. Strong communicator skilled in client relations, time management, and leveraging technology to boost productivity.`,
...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    image: "/images/JumpQuest.jpg", // UPDATED PATH
